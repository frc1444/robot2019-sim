    ...
    public Action createAction(
        ...
        if (autonomousType == AutonomousType.DO_NOTHING) {
            ...
            if(lineUpType == LineUpType.USE_VISION) {
                ...
                successQueue.add(actionCreator.createGoStraight(inchesToMeters(10), .3, driveAngle.rotate90(2), driveAngle));
                ...
                actionQueue.add(actionCreator.createDropHatch());
                actionQueue.add(actionCreator.createGoStraight(inchesToMeters(10), .2, driveAngle.rotate90(2), driveAngle));
